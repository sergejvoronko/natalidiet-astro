...
ingredients:
  - amount: "250g"
    name: "low-fat cottage cheese (tvaroh), well-drained"
  - amount: "1"
    name: "large egg"
  - amount: "80g"
    name: "whole wheat flour, plus extra for dusting"
  - amount: "1 pinch"
    name: "salt"
  - amount: "8"
    name: "medium ripe plums, pitted"
  - amount: "20g"
    name: "butter"
  - amount: "100g"
    name: "low-fat Greek yogurt or quark"
  - amount: "20g"
    name: "ground walnuts or poppy seeds"
  - amount: "1 tbsp"
    name: "erythritol or sweetener of choice"
  - amount: "1/2 tsp"
    name: "ground cinnamon"
steps:
  - "In a large bowl, combine the well-drained cottage cheese, egg, and salt. Mash with a fork until it's relatively smooth."
  - "Gradually stir in the whole wheat flour until a soft, slightly sticky dough forms. Be careful not to overmix. Let the dough rest for 5 minutes."
  - "Divide the dough into 8 equal portions. On a lightly floured surface, flatten each portion into a small disc just large enough to encase a plum."
  - "Place one pitted plum in the center of each disc. Carefully wrap the dough around the plum, pinching the seams to seal it completely. Gently roll it between your palms to form a smooth ball."
  - "Bring a large pot of lightly salted water to a gentle boil. Carefully lower the dumplings into the water, ensuring not to overcrowd the pot. You may need to cook them in two batches."
...
I think these are best served warm, fresh from the pot, when the dough is at its softest. They make a fantastic afternoon snack or a light, satisfying dessert. The classic topping is melted butter and some form of sweetened cheese or yogurt, with a sprinkle of something crunchy. I love ground walnuts for their earthy flavour, but traditional poppy seeds are also wonderful. A final dusting of cinnamon ties everything together.
