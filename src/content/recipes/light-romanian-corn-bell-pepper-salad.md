...
ingredients:
  ...
  - amount: "400g"
    name: "canned sweet corn, drained"
  - amount: "1"
    name: "small red onion"
  - amount: "1/2"
    name: "bunch fresh dill, chopped"
  - amount: "1/2"
    name: "bunch fresh parsley, chopped"
  - amount: "2 tbsp"
...
steps:
  - "First, prepare the chicken and peppers. Preheat your grill or a griddle pan to medium-high. Season the chicken breast with a pinch of salt and pepper. Place the whole bell peppers directly on the grill or under a broiler."
  - "Grill the chicken for about 6-8 minutes per side, or until cooked through with an internal temperature of 75°C (165°F). Set aside to rest."
  - "Continue to cook the bell peppers, turning them occasionally, until the skin is blackened and blistered all over, which takes about 15-20 minutes. The flesh should be soft."
  - "Once the peppers are charred, place them in a bowl and cover tightly with a plate or plastic wrap. Let them steam for 10 minutes. This is the secret to peeling them easily."
  - "While the peppers steam, finely chop the red onion, dill, and parsley. Add them to a large salad bowl along with the drained sweet corn."
  - "Peel the blackened skin from the steamed peppers; it should slide right off. Remove the stem and seeds, then chop the sweet, smoky flesh into bite-sized pieces. Add them to the bowl."
