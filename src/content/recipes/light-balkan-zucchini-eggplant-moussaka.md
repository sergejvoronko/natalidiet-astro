...
ingredients:
  - amount: "1 medium"
    name: "eggplant (~300g), thinly sliced"
  - amount: "1 large"
    name: "zucchini (~300g), thinly sliced"
  - amount: "1 large"
    name: "potato (~200g), very thinly sliced"
  - amount: "1 tbsp"
    name: "olive oil"
  - amount: "1 medium"
...
steps:
  - "Preheat your oven to 200°C (400°F). Lightly grease a medium baking dish."
  - "Arrange the thinly sliced eggplant, zucchini, and potato on a baking sheet. Brush lightly with a little of the olive oil and season with salt and pepper. Bake for 15 minutes, or until just tender. This is much lighter than frying."
  - "While the vegetables are baking, heat the remaining olive oil in a pan over medium heat. Add the finely chopped onion and cook until soft, about 5 minutes. Add the minced garlic and cook for another minute until you can smell it."
  - "Add the lean ground chicken to the pan, breaking it up with a spoon. Cook until it's no longer pink. Drain any excess fat."
  - "Pour in the can of chopped tomatoes, dried oregano, and sweet paprika. Season with salt and pepper. Let it simmer for 10 minutes for the flavours to combine."
  - "In a small bowl, whisk together the low-fat Greek yogurt, egg, and fresh dill. Season with a pinch of salt."
  - "Now, assemble the moussaka. Place a single layer of the baked potato slices on the bottom of your baking dish. Top with half of the meat sauce, then a layer of zucchini, then a layer of eggplant. Repeat with the remaining meat sauce and vegetables."
